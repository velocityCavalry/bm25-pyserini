...
def return_q2id_answer_xor(file, lang):
    q2idan = dict()
...
def main():
    ...
    parser.add_argument('--xor', action='store_true', help='index xor question files and output squad formatted data')
    ...
    if args.lang == 'ar':
        ...
        analyzer = analysis.get_lucene_analyzer(name="English2")
        searcher.set_analyzer(analyzer)
    elif args.lang == 'bn':
    ...
    if args.xor:
        q2id = return_q2id_answer_xor(args.query_path, args.lang)
